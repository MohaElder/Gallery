...
{
    //modified from https://gist.github.com/KarlRamstedt/407d50725c7b6abeaf43aee802fdd88e
	...
	void Update(){
        if (Bank.started)
        {
            ...
            cam.focalLength = Mathf.Lerp(56, 135, t);

            if (Input.GetKey(KeyCode.Tab))
            {
                t = t >= 1.0f ? 1.0f : (t + 3f * Time.deltaTime);
            }
            else
            {
                t = t <= 0.0f ? 0.0f : (t - 3f * Time.deltaTime);
            }
